...
from src.cli.logit_feature_response_curve_suite.run_csqa_logit_feature_response_curve_pipeline import main as base_main
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the CSQA logit-feature response-curve pipeline for a Meta Llama 3.2 Instruct model suite."
    )
    parser.add_argument(
        "--sizes",
        type=str,
