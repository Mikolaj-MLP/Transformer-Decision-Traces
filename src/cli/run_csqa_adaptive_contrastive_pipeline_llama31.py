...
from src.cli.run_csqa_adaptive_contrastive_pipeline import main as base_main
from src.csqa.model_presets import resolve_llama31_instruct_model_id


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the CSQA adaptive contrastive pipeline for Meta Llama 3.1 Instruct."
    )
